...
$list = [
    ['name' => 'My Tasks', 'content' => '130 / 500', 'stripe'=> 'bg-fusion-400', 'width' => '65'],
    ['name' => 'Transfered', 'content' => '440 TB', 'stripe'=> 'bg-success-500', 'width' => '34'],
    ['name' => 'Bugs Squashed', 'content' => '77%', 'stripe'=> 'bg-info-400', 'width' => '77'],
    ['name' => 'User Testing', 'content' => '7 days', 'stripe'=> 'bg-primary-300', 'width' => '84'],
];
                ...
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <div class="d-flex">
                                <?= $elem['name'] ?>
                                <span class="d-inline-block ml-auto"><?= $elem['content'] ?></span>
                            </div>

                            <div class="progress progress-sm mb-g">
                                <div class="progress-bar <?= $elem['stripe'] ?>" role="progressbar" style="width: <?= $elem['width'] ?>%;" aria-valuenow="<?= $elem['width'] ?>" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <?php endforeach ?>
                        </div>
                    </div>
